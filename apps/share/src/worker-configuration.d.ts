/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts -c ./wrangler.jsonc -c ../../services/auth/wrangler.jsonc` (hash: 88f36311ed044f99007e6bd9374317cd)
// Runtime types generated with workerd@1.20251113.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.cloudflare/worker");
	}
	interface Env {
		BUCKET_ASSETS: R2Bucket;
		DB: D1Database;
