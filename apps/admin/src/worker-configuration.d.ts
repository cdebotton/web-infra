/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts -c ./wrangler.jsonc -c ../services/auth/wrangler.jsonc` (hash: 525b344ff9cbd6431841a2e3d2a6bdbb)
